# Demo video script — `mitre_attack_datathon`
...
**Screen:** Title slide with `TUTORIAL-MITRE: ATT&CK-Tied Investigations with Pedagogy` and tagline.  
...
integrations relevant to `mitre_attack_datathon`.
...
**Narration:** Tie each UI/API element to the hackathon angle: Explicit tactic/technique language in investigation steps, exportable timelines, and lesson linkages that reinforce ATT&CK literacy for collegiate competitors.…
