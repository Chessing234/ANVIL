# TUTORIAL-MITRE: ATT&CK-Tied Investigations with Pedagogy

**Map tactics, teach techniques.**

This folder is the `mitre_attack_datathon` hackathon submission slice for **Project TUTORIAL** — an agentic
...
Explicit tactic/technique language in investigation steps, exportable timelines, and lesson linkages that reinforce ATT&CK literacy for collegiate competitors.
