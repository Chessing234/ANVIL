# Demo video script — `microsoft_defender_hack`
...
**Screen:** Title slide with `TUTORIAL-Defender: XDR Narratives That Teach While They Hunt` and tagline.  
...
integrations relevant to `microsoft_defender_hack`.
...
**Narration:** Tie each UI/API element to the hackathon angle: Windows-centric investigation heuristics, host isolation simulations, and lesson cards that mirror Defender incident queues.…
