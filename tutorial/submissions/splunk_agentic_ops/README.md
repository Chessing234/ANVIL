# TUTORIAL-Ops: Agentic Security Operations with a Real-Time STEM Education Pipeline

**Turn every security alert into a learning opportunity.**

This folder is the `splunk_agentic_ops` hackathon submission slice for **Project TUTORIAL** — an agentic
...
Splunk MCP integration, SPL generation with validation, threat-hunt templates, and live observability hooks that narrate operator actions into teachable moments.
