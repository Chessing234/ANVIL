...
**Screen:** Title slide with `TUTORIAL-Chain: On-Chain Agent Identity for Decentralized Cybersecurity Education` and tagline.  
...
integrations relevant to `turing_test`.
...
**Narration:** Tie each UI/API element to the hackathon angle: Verifiable credential NFT flows, wallet-linked student profiles, and tamper-evident lesson attestations suitable for DeFi-adjacent education pilots.…
