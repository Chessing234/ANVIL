# TUTORIAL-Chain: On-Chain Agent Identity for Decentralized Cybersecurity Education

**Trustless security, verifiable learning.**

This folder is the `turing_test` hackathon submission slice for **Project TUTORIAL** — an agentic
...
Verifiable credential NFT flows, wallet-linked student profiles, and tamper-evident lesson attestations suitable for DeFi-adjacent education pilots.
