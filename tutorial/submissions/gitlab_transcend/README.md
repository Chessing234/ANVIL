# TUTORIAL-Dev: AI Agents for Secure Development & Developer Education

**Every commit is a learning opportunity.**

This folder is the `gitlab_transcend` hackathon submission slice for **Project TUTORIAL** — an agentic
...
Secure SDLC storytelling: investigations that reference dependency risk, CI/CD hygiene, and merge-request friendly exports for GitLab-based review workflows.
