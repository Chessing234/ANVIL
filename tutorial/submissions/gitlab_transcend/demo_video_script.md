# Demo video script — `gitlab_transcend`
...
**Screen:** Title slide with `TUTORIAL-Dev: AI Agents for Secure Development & Developer Education` and tagline.  
...
integrations relevant to `gitlab_transcend`.
...
**Narration:** Tie each UI/API element to the hackathon angle: Secure SDLC storytelling: investigations that reference dependency risk, CI/CD hygiene, and merge-request friendly exports for GitLab-based review workflows.…
