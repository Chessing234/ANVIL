# Demo video script — `verizon_threat_hack`
...
**Screen:** Title slide with `TUTORIAL-Telco: Carrier-Scale Threat Narratives for Analyst Pipelines` and tagline.  
...
integrations relevant to `verizon_threat_hack`.
...
**Narration:** Tie each UI/API element to the hackathon angle: DNS tunneling templates in SPL heuristics, high-throughput JSON APIs, and rate-limited public endpoints suitable for telco SOC modernization pitches.…
