# TUTORIAL-Fly: Global Edge Demos for Classroom-Scale SOC

**Spin up a SOC in minutes, teach in seconds.**

This folder is the `fly_io_edge_deploy` hackathon submission slice for **Project TUTORIAL** — an agentic
...
Single-command Docker Compose, health-checked API, and static SPA suitable for Fly Machines or any container edge with persistent volumes for SQLite workloads.
