# Demo video script — `dsh_hacks_v1`
...
**Screen:** Title slide with `TUTORIAL-EDU: Turning Real Cyber Attacks Into Interactive CS Curriculum` and tagline.  
...
integrations relevant to `dsh_hacks_v1`.
...
**Narration:** Tie each UI/API element to the hackathon angle: STEM-first pedagogy: sandbox terminals, CSTA mapping endpoints, difficulty-aware narratives, and measurable learning outcomes tied to each incident.…
