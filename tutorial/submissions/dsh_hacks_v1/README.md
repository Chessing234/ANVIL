# TUTORIAL-EDU: Turning Real Cyber Attacks Into Interactive CS Curriculum

**Real incidents. Interactive lessons. Real skills.**

This folder is the `dsh_hacks_v1` hackathon submission slice for **Project TUTORIAL** — an agentic
...
STEM-first pedagogy: sandbox terminals, CSTA mapping endpoints, difficulty-aware narratives, and measurable learning outcomes tied to each incident.
