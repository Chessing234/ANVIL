# Demo video script — `tailscale_zero_trust`
...
**Screen:** Title slide with `TUTORIAL-Mesh: Zero-Trust Investigations Across Ephemeral Environments` and tagline.  
...
integrations relevant to `tailscale_zero_trust`.
...
**Narration:** Tie each UI/API element to the hackathon angle: Edge compose profiles, private networking assumptions, and operator guidance for running behind identity-aware proxies without exposing student data.…
