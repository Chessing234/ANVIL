# Demo video script — `elastic_agent_hack`
...
**Screen:** Title slide with `TUTORIAL-Elastic: Agentic Detection Engineering with Explainable Lessons` and tagline.  
...
integrations relevant to `elastic_agent_hack`.
...
**Narration:** Tie each UI/API element to the hackathon angle: JSON evidence chains, timeline exports compatible with SIEM analysts, and Elasticsearch-style aggregations in narrative copy for observability-native teams.…
