# Demo video script — `hackforge_cyber`
...
**Screen:** Title slide with `TUTORIAL-Forge: Build-Your-Own Agent Lab for Blue Teams` and tagline.  
...
integrations relevant to `hackforge_cyber`.
...
**Narration:** Tie each UI/API element to the hackathon angle: Open codebase, reproducible demos, and modular agents (defense, teaching, integrations) ideal for competitive build tracks focused on engineering depth.…
