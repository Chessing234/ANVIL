# TUTORIAL-Forge: Build-Your-Own Agent Lab for Blue Teams

**Hack, break, replay, learn.**

This folder is the `hackforge_cyber` hackathon submission slice for **Project TUTORIAL** — an agentic
...
Open codebase, reproducible demos, and modular agents (defense, teaching, integrations) ideal for competitive build tracks focused on engineering depth.
