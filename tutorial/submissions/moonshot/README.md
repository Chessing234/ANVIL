# TUTORIAL-Moonshot: Protective Education as Civilizational Infrastructure

**When defense and teaching share one nervous system, societies become antifragile.**

This folder is the `moonshot` hackathon submission slice for **Project TUTORIAL** — an agentic
...
First-principles argument for coupling incident response with pedagogy; includes required Moonshot paper (MOONSHOT_PAPER.md) on protective education as a new primitive.
