...
**Screen:** Title slide with `TUTORIAL-Moonshot: Protective Education as Civilizational Infrastructure` and tagline.  
...
integrations relevant to `moonshot`.
...
**Narration:** Tie each UI/API element to the hackathon angle: First-principles argument for coupling incident response with pedagogy; includes required Moonshot paper (MOONSHOT_PAPER.md) on protective education as a new primitive.…
