# Demo video script — `usaii_global_ai`
...
**Screen:** Title slide with `TUTORIAL-Good: AI That Protects Communities While Building Cyber Literacy` and tagline.  
...
integrations relevant to `usaii_global_ai`.
...
**Narration:** Tie each UI/API element to the hackathon angle: Responsible AI guardrails, transparent investigation steps, and public-interest framing: defenders learn while organizations improve resilience.…
